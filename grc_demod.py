...
class grc_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Grc Demod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Grc Demod")
        ...
        self.samp_per_sym = samp_per_sym = samp_rate/2800.0
        ...
        self.tabs_grid_layout_1.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.qtgui_freq_sink_x_0_0.set_y_axis(-50, 60)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_short_to_float_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_udp_source_0_0, 0), (self.blocks_short_to_float_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_samp_per_sym(self.samp_rate/2800.0)
...
def main(top_block_cls=grc_demod, options=None):
